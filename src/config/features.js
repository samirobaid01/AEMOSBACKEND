module.exports = {
  security: {
    ...
    rateLimit: {
      ...
      max: parseInt(process.env.RATE_LIMIT_MAX || 10000, 10), // 100 requests per window
    },
  ...
  // inside features: { ... }
  coap: {
    enabled: process.env.ENABLE_COAP === 'true',
    host: process.env.COAP_HOST || '0.0.0.0',
    port: parseInt(process.env.COAP_PORT || '5683', 10),
    // Optionally: dtlsEnabled: process.env.COAP_DTLS === 'true'
  },
  mqtt: {
